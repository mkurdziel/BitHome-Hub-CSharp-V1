...
namespace SyNet.BindingHelpers
{
  ...
  public static class ArgumentHelper
  {
    ...
    /// <remarks>
    /// <para>
    /// This method can be used instead of one of the overloads in the case where the argument
    /// being checked is generic. It will ensure that <paramref name="arg"/> is nto <see langword="null"/> if it is a
    ...
    {
      if (string.IsNullOrEmpty(arg) || (trim && (arg.Trim().Length == 0)))
      {
