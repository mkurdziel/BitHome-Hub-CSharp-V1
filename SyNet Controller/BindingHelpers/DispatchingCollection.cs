...
namespace SyNet.BindingHelpers
{
    ...
    where TCollection : ICollection<TItem>, INotifyCollectionChanged
  {
    ...
    /// </summary>
    /// <returns>
    /// An <see cref="System.Collections.IEnumerator"/> that iterates over the items in this collection.
    /// </returns>
    ...
    private void OnCollectionChanged(NotifyCollectionChangedEventArgs e)
    {
      ...
      {
        _dispatcher.BeginInvoke(DispatcherPriority.Send, new OnCollectionChangedHandler(OnCollectionChanged), e);
      }
    }
  }
}